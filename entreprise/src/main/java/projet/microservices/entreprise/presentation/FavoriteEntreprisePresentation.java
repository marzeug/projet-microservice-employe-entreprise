...
@Component
@Path("favorites")
public class FavoriteEntreprisePresentation {

	private final EntrepriseService service;
	private final EntrepriseMapper mapper;

	public FavoriteEntreprisePresentation(EntrepriseService service, EntrepriseMapper mapper) {
    ...
    public List<EntrepriseDTO> getFavoriteEntreprises() {
    ...
    for (Entreprise e : entreprisesBdd) {
        ...
        if(	e.isFavorite()) entreprisesRetournees.add(dto);
    }
